...
export default function LandingPortal({ onLaunchPortal }) {
  const { scannerConnection, isRealHardware } = useScanner();
  ...
  return (
    <div className="landing-layout">
      ...
      <div className="landing-top-bar">
        ...
        {scannerConnection === 'connected' && !isRealHardware && (
          <div className="landing-device-pill" style={{ background: 'rgba(245,158,11,0.12)', color: '#D97706', border: '1px solid rgba(217,119,6,0.3)', marginLeft: '8px' }}>
            <span style={{ width: 7, height: 7, borderRadius: '50%', background: '#F59E0B', display: 'inline-block', marginRight: 6 }}></span>
            <span>SIMULATION MODE — No Physical Device</span>
          </div>
        )}
      </div>
